...
export const canvaProvider = {
  ...
  toolManifest: [
    ...
    },
    {
      ...
      description: "Start a Canva asset upload job from a public URL or binary upload.",
      method: "POST",
      path: "/asset-uploads",
      paramsSchema: {
        type: "object",
    ...
    {
      name: "get_asset_upload",
      description: "Get the status and resulting asset for a Canva upload job.",
      method: "GET",
